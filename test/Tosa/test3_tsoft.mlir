module {
  func.func @test_tsoft() -> tensor<3x3x3xf32> {
    ...
    %t1 = "tosa.transpose"(%input1, %perm) : (tensor<3x3x3xf32>, tensor<3xi32>) -> tensor<3x3x3xf32>

    %t2 = "tosa.transpose"(%input2, %perm) : (tensor<3x3x3xf32>, tensor<3xi32>) -> tensor<3x3x3xf32>

    %soft = "tosa.add"(%t1, %t2) : (tensor<3x3x3xf32>, tensor<3x3x3xf32>) -> tensor<3x3x3xf32> 

    %tsoft = "tosa.transpose"(%soft, %perm) : (tensor<3x3x3xf32>, tensor<3xi32>) -> tensor<3x3x3xf32>

    // Return the result
    return %tsoft : tensor<3x3x3xf32>
  }
}
